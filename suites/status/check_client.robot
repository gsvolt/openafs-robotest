...
Same clock on all servers
    ...
    ${rc_client1}    ${output_client1}=    client1.Run And Return Rc and Output    date --utc
    ${time_client1}=    Convert Date    ${output_client1}    result_format=datetime    date_format=DATE_FORMAT

    ${rc_client2}    ${output_client2}=    client2.Run And Return Rc and Output    date --utc
    ${time_client2}=    Convert Date    ${output_client2}    result_format=datetime    date_format=DATE_FORMAT
